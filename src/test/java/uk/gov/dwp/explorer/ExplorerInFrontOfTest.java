...
public class ExplorerInFrontOfTest {
    ...
    */
    ...
    public void shouldReturnInvalidStateGivenExplorerFacingNorthAndIsOnTopEdgeOfMaze() {
        final Explorer explorer = getExplorerWithNewEntryLocation(NEW_MAZE, new Location(DIRECTION.N, 3,3),MAZE.getEntryPoint());
    ...
    */
    ...
    public void shouldReturnInvalidStateGivenExplorerFacingSouthAndIsOnBottomEdgeOfMaze() {
        final Explorer explorer = getExplorerWithNewEntryLocation(NEW_MAZE, new Location(DIRECTION.S, 3,0),MAZE.getEntryPoint());
        assertEquals(-1, explorer.inFrontOfMe());
    }
    ...
    */
    ...
    public void shouldReturnInvalidStateGivenExplorerFacingEastAndIsOnRightEdgeOfMaze() {
        final Explorer explorer = getExplorerWithNewEntryLocation(NEW_MAZE, new Location(DIRECTION.E, 4,2),MAZE.getEntryPoint());
        assertEquals(-1, explorer.inFrontOfMe());
    }
    ...
    */
    ...
    public void shouldReturnInvalidStateGivenExplorerFacingWestAndIsOnLeftEdgeOfMaze() {
        final Explorer explorer = getExplorerWithNewEntryLocation(NEW_MAZE, new Location(DIRECTION.W, 0,3),MAZE.getEntryPoint());
        assertEquals(-1, explorer.inFrontOfMe());
    }
